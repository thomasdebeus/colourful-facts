---
title: "Accessing Tidy CBS (Centraal Bureau voor Statetiek) data"
...
```{r list, message=FALSE, warning=FALSE, results='hide', eval=FALSE}
library(cbsodataR)
...
```{r access, message=FALSE, warning=FALSE, results='hide', eval=FALSE}
