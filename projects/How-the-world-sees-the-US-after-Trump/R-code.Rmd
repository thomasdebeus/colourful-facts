...
## [How the world sees the U.S.A. after Trump](https://medium.com/tdebeus/how-the-world-sees-the-u-s-a-after-trump-2f2ad6dd0e12)
...
# Running authencation from google sheets in Chrome browser.
gs_ls()
...
```{r comparison plot, echo=TRUE, out.width = "50%", fig.align = "center"}
